            ...
            <div className="container mx-auto max-w-7xl">
                <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr]">
                        {/* Seção da foto */}
                        <div className="bg-linear-to-br from-rose-300 via-purple-500 to-indigo-500 p-8 flex flex-col items-center justify-center">
                            ...
                            <h2 className="text-white text-2xl font-bold mt-16 text-center">{user.nome}</h2>
                        ...
                        <div className="p-8 lg:p-12">
                            ...
                            <form onSubmit={atualizarUsuario} className="space-y-6">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                    <button
                                        type="button"
                                        className="flex-1 px-6 py-3 bg-purple-300 text-gray-700 font-semibold rounded-xl hover:bg-gray-200 transition-colors"
                                        onClick={retornar}
                                    >
                                        Cancelar
                                    </button>
                                    <button
                                        type="submit"
                                        className="flex-1 px-6 py-3 bg-linear-to-r from-purple-600 to-purple-400 text-white font-semibold rounded-xl hover:from-purple-700 hover:to-purple-800 shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
                                        disabled={isLoading}
                                    >
                                        {isLoading ? (
